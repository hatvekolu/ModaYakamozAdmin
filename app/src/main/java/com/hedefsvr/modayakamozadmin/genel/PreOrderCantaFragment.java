 ...
 */
public class PreOrderCantaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        urunler.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                alertDialog.setPoc(PreOrderCantaFragment.this);
    ...
    private class getData extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... values)
        {
            ...
            try{
                String gelenData=readURL.readURL("http://modayakamoz.com/admin/get_pre_urunler.php?kategori=2");
