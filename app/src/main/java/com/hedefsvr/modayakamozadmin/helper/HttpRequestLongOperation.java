...
public class HttpRequestLongOperation extends AsyncTask<String, Void, String> {
    ...
    public HttpRequestLongOperation(Context ctx, String url, String method, Map<String, String> data, String img, TextView dynamicTextView,String son ,TaskListener listener) {
        context =  ctx;
        durum=son;
        inputUrl = url;
        stringMethod = method;
    ...
    public HttpRequestLongOperation(Context ctx, String url, String method, Map mapData, String send, TextView textViewDynamicText, TaskListener listener) {
        context = ctx;
        inputUrl = url;
        stringMethod = method;
        stringSend = send;
    ...
    protected void onPreExecute() {
        ...
        progress = ProgressDialog.show(context, "Giriş Yapılıyor", "Lütfen Bekleyin...", true);
        textViewJSON.setText("Yükleniyor...");
