    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pairedDevices.size() > 0) {
            ...
            for (BluetoothDevice device : pairedDevices) {
                if (device.getAddress().equals(GenerateQRFragment.macXprint))
                    mPairedDevicesArrayAdapter.add("Xprinter" + "\n" + device.getAddress());
                else if (device.getAddress().equals(GenerateQRFragment.macZywell))
                    mPairedDevicesArrayAdapter.add("Zywell" + "\n" + device.getAddress());
                else
